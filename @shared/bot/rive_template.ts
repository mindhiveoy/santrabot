...
// Korvattavat tekstit ennen tulkintaa
! sub mä;       = minä
! sub miä       = minä
! sub joo       = kyllä
! sub &lt;      = <
...
! person minä olen  = sinä olet
! person sinä olet  = minä olen
! person minun   = sinun
! person sinun   = minun
! person sinä    = minä
! person minä    = sinä
...
! array kyllä      = kyllä jep joo jup yes daa
! array no         = ei no nope eips

// Learn stuff about our users.

+ nimeni on *
- <set name=<formal>>Hauska tavata, <get name>.
- <set name=<formal>><get name>, hienoa tavata.

+ kutsu minua <bot master>
