...
import ChatContainer, { ChatSessionState } from "chat";
import MainScreen, {
  DrawerItem
...
class PersonalizeScreen extends React.Component<PersonalizeProps, State> {
      ...
      <MainScreen drawerItems={drawerItems}>
        ...
        <ChatPreviewContainer>
          ...
          <ChatContainer
            ...
            designMode={true}
            messageHandler={this.readyMessageHandler}
          />
        </ChatPreviewContainer>
  ...
  private renderFirstColumn = () => {
    ...
    return (
      <FormContainer>
        <FormField>
          <Typography id="chatInputPlaceHolder">
            Chattilaatikon vihjeteksti
          </Typography>
          <StyledTextField
      ...
      <FormContainer>
        <FormField>
          ...
          <ColorPicker
            ...
            title="Fonttiväri"
            onPickColor={this.handleModelChange("color")}
          />
          <ColorPicker
  ...
  private handleModelBubbleChangeEvent = (
    buble: "user" | "bot",
    key: keyof ChatBubbleTheme
  ...
  private handleModelChange = (key: keyof ChatConfiguration) => (
    value: any
  ) => {
    const configuration = {
  ...
  private handleModelBubbleChange = (
    buble: "user" | "bot",
    key: keyof ChatBubbleTheme
  ) => (value: any) => {
    const configuration = { ...this.state.configuration } as ChatConfiguration;
  ...
  private handleChange = (key: keyof ChatConfiguration) => (
